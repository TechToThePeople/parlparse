...
//  url:"http://www.europarl.europa.eu/plenary/en/texts-submitted.html",
  report:"http://www.europarl.europa.eu/oeil/search/search.do?searchTab=y&q=documentEP:D-A8-????/????&snippet=true&noHeader=false&lang=en&dismax=y&all&limit=3000",
  motion:"http://www.europarl.europa.eu/oeil/search/search.do?searchTab=y&q=documentEP:D-B8-????/????&snippet=true&noHeader=false&lang=en&dismax=y&all&limit=4000",
};
...
[2019,2018,2017,2016,2014].forEach( yy => {
  scrape(options.report.replace("/????","/"+yy),{},"report")
  .then(()=>{
